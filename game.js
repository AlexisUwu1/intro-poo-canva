...
class Ball { 
    ...
    draw() { 
        ...
        ctx.fillStyle = this.color; // Usar el color especificado
        ctx.fill(); 
        ctx.closePath(); 
    } 
...
class Game { 
    constructor() { 
        // Crear 5 pelotas con diferentes tamaños y colores
        this.balls = [
            new Ball(400, 300, 15, 3, 3, 'cyan'),    // Pelota 1: Cian
            new Ball(200, 150, 10, 2, 2, 'orange'),  // Pelota 2: Naranja
            new Ball(600, 450, 20, 4, 4, 'gray'),    // Pelota 3: Gris
            new Ball(100, 100, 25, 5, 3, 'blue'),    // Pelota 4: Azul
            new Ball(500, 350, 8, 3, 4, 'green')     // Pelota 5: Verde
        ];
        // Paleta del jugador (doble de alto y color verde)
        this.paddle1 = new Paddle(0, canvas.height / 2 - 100, 10, 200, 'green', true);
        // Paleta del enemigo (color rojo)
    ...
    update() { 
        ...
        this.paddle2.autoMove(this.balls[0]); // El enemigo sigue la primera pelota
